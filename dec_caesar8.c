// Let's try and bring it home
// just looking to change how things print out in this iteration. I think that is the last step
// I don't have to do the error checking if a non character is entered on the command line.
// if I do, a function might help me there.
